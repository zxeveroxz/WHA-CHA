...
const {avisos_agua, buscar_avisos_agua} = require('./utils/agua');
const { avisos_desague, buscar_avisos_desague } = require('./utils/desague');
...
http.createServer({
    ...
    console.log("My HTTPS server listening on port 3003...");
